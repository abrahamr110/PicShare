<div class="bg-white shadow-md p-4">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <a href="/laravel/picshare/public/" class="flex items-center space-x-2 text-2xl font-semibold text-fuchsia-700">
        ...
        <div class="hidden md:flex space-x-8 items-center">
            <div class="relative">
                <input type="text" placeholder="Buscar" class="border border-gray-300 p-2 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-500" />
                
            </div>
    
            <a href="{{ route('user.showProfile') }}" class="text-sm text-gray-600 hover:text-fuchsia-700 transition">Perfil</a>
            ...
            @guest
                ...
                <a href="{{ route('user.doRegister') }}" class="text-sm text-gray-600 hover:text-fuchsia-700 transition">Registrarse</a>
            @endguest
        </div>
        ...
        <div class="md:hidden flex items-center space-x-4">
            ...
            <button class="text-gray-600 hover:text-fuchsia-700 transition">
